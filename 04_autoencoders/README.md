...
## What's inside
- `04_autoencoder.ipynb` - the interactive Google Colab notebook ([Run on Google Colab](https://colab.research.google.com/github/WeihaoGe1009/ai-history-for-ip-scholars/blob/main/04_autoencoders/04_autoencoder.ipynb)),containing
...
## What You'll learn
* What is an autoencoder and what does it do?
* How does an autoencoder "learn" a pattern?
* How does an autoencoder "reconstruct" a pattern?
* What is the application in autoencoders? 
...
## Data
* STL-10 Images (unlabeled) from pyTorch 

## Data Source:
* STL-10 (unlabeled) from pyTorch, public domain data
* Noisy test images were generated by adding Gaussian noise to STL-10 test images; no external noisy data were collected.

## References
* **Autoencoder** Hinton, G. E., and R. R. Salakhutdinov. "Reducing the Dimensionality of Data with Neural Networks." Science, vol. 313, no. 5786, 2006, pp. 504–07.
...
* **Principle Component Analysis** olliffe, Ian T., and Jorge Cadima. "Principal Component Analysis: A Review and Recent Developments." Philosophical Transactions of the Royal Society A, vol. 374, no. 2065, 2016.
* **TensorFlow** Abadi, Martín, et al. TensorFlow: Large-Scale Machine Learning on Heterogeneous Systems. 2015, https://www.tensorflow.org/.
* **scikit-learn** Pedregosa, Fabian, et al. "Scikit-learn: Machine Learning in Python." Journal of Machine Learning Research, vol. 12, 2011, pp. 2825–30.
